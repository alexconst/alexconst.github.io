...
The Vagrant boxes are created using [Packer](2016/01/08/packer). And these
consist on a tar file which include the virtualization software VM files
(eg: .ovf and .vmdk) and a couple of Vagrant specific files.  
...
with [Packer](2016/01/08/packer)) and how to set up a development environment
